...
import br.com.jonasrosendo.notepad.adapters.CategoryAdapter;
import br.com.jonasrosendo.notepad.models.Category;
...
public class WriteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgb_add_category.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog customDialog = new Dialog(WriteActivity.this);
    ...
    private void saveCategory(String name){
        ...
        if(!TextUtils.isEmpty(name)){
            ...
            Toast.makeText(WriteActivity.this, R.string.category_saved, Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(WriteActivity.this, R.string.fill_fields, Toast.LENGTH_SHORT).show();
        }
    }
    private void saveNote(){
        ...
        if(!TextUtils.isEmpty(title) && !TextUtils.isEmpty(content)){
            ...
            Toast.makeText(WriteActivity.this, R.string.note_saved, Toast.LENGTH_SHORT).show();
            finish();
    ...
    private void loadCategory(){
        ...
        noteDB.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new CategoryAdapter(WriteActivity.this, categoryList);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(WriteActivity.this, R.string.category_download_failed, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onStart() {
        super.onStart();
        Log.d("TEST_SPINNER", "OnStart() Called");
        loadCategory();
    }
}
